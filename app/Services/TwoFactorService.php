<?php
// управление двухфакторной аутентификацией (2FA) и
//  предоставляет методы для генерации, проверки, отправки и очистки 2FA-кодов
...
class TwoFactorService
{
  ...
  {
    return Hash::check($code, $user->two_fa_code) && $user->two_fa_expires_at
    ->isFuture();
  }
